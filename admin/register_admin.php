...
if(isset($_POST['submit'])){
   ...
   if($select_admin->rowCount() > 0){
      $message[] = 'Esse nome do usuário já existe!';
   }else{
      if($pass != $cpass){
...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="cpass" maxlength="20" required placeholder="Confirme a sua senha" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="submit" value="register now" name="submit" class="btn">
   </form>

</section>

<!-- fim da section do admin -->
