...
if(isset($_POST['delete_all'])){
   ...
   $message[] = 'Todos os produtos foram deletados do carrinho';
}
...
if(isset($_POST['update_qty'])){
   ...
   $message[] = 'Quantidade do carrinhoa atualizado!';
}
...
<section class="products">
   ...
   <div class="cart-total">
      ...
      <a href="checkout.php" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>">Prosseguir para o pagamento</a>
   </div>

   <div class="more-btn">
      <form action="" method="post">
         <button type="submit" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" name="delete_all" onclick="return confirm('Deletar tudo do carrinho?');">Deletar todos os produtos</button>
      </form>
...
<!-- começo da section do footer  -->
<?php include 'components/footer.php'; ?>
<!-- fim da section do footer -->
